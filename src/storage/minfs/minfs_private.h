...
class Minfs :
 ...
 public:
  ...
  // Removes |dirty_bytes| number of bytes to from dirty bytes metrics.
  void RemoveDirtyBytes(uint64_t dirty_bytes, bool allocated) FS_TA_EXCLUDES(hash_lock_);
